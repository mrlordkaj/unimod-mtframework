 ...
 * @author Thinh Pham
 */
public class MTMesh21 extends IMesh {
    ...
    final short matIndex;
    final short levelOfDetail; // ubyte
    final byte clazz; // what class
    final byte vertexFlag; // meshClass
    final byte vertexStride;
    final byte renderMode;
    final int indexStart;
    final int vertexOffset;
    final int vertexFormat;
    final int indexPosition;
    final int indexCount;
    final int indexOffset;
//    final byte boneMapIndex;
    final byte vertexGroupCount;
    final byte unk2, unk3;
    final short minIndex;
    final short maxIndex;
    final int hash;
    
    MTMesh21(DataStream ds) {
        // header
        flags = ds.getShort();
