...
class MTModel15 extends MTModel {
    ...
    protected final short groupIndex;
    protected final short materialIndex;
    private final byte const1; // always 1
//    private final short levelOfDetail; // ubyte
    private final byte unk1;
    private final byte vertexFormat; // from 0 to 8
    private final byte vertexStride;
    private final byte vertexFlag; // 0 or 8
    private final byte unk3;
    private final byte unk4;
    private final short vertexCount;
    private final short vertexIndexEnd;
    private final int indexStart1;
    private final int vertexOffset1;
    private final int vertexOffset2;
    private final int indexPosition;
    private final int indexCount;
    private final int indexOffset;
    private final byte unk6;
    private final byte unk7;
    private final short indexStart2;
    private final byte vertexGroupCount; // weightMapCount????
//    protected final byte boneMapIndex;
    private final int minIndex; // ushort
    ...
    MTModel15(DataStream ds) {
        ...
        meshAsModel.materialName = String.format("material_%1$03d", materialIndex);
    }
    ...
    void readIndexBuffer(DataStream ds) {
        try {
            ...
            meshAsModel.setIndices(WorldHelper.triangleStrip2TriangleList(strips));
        } catch (IndexOutOfBoundsException ex) {
            // TODO: avoid bug in uOm1303_Truck.arc
            Logger.printError("Error while reading %1$s", getName());
            meshAsModel.setIndices(new short[0]);
        }
    }
